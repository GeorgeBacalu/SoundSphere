...
namespace SoundSphere.Test.Mocks
{
    public class ArtistMock
    {
        ...
        public static Artist GetArtist1() => new()
        {
            ...
            Name = "artist_name1",
            ImageUrl = "https://artist_image1.jpg",
            Bio = "artist_bio1",
        ...
        public static Artist GetArtist2() => new()
        {
            ...
            Name = "artist_name2",
            ImageUrl = "https://artist_image2.jpg",
            Bio = "artist_bio2",
            SimilarArtists = [],
        ...
        public static Artist GetNewArtist() => new()
        {
            Name = "new_artist_name",
            ImageUrl = "https://new_artist_image.jpg",
            Bio = "new_artist_bio",
            SimilarArtists = []
        };
        ...
        public static ArtistDto GetNewArtistDto() => ToDto(GetNewArtist());
